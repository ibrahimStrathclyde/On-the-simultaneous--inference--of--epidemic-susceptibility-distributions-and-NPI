...
n_replicates <- 200   # number of data simulated 
...
v_spec=0  # value for the coeffient of variation when the SEIR model is homogenous
# Case II(b): Simulate heterogeneous data (CV appox  1.414)  CASE I b set CV_simulation=0
...
# =============================================================================
# STEP 3: FIT HETEROGENEOUS MODEL 
# =============================================================================
...
# Save plots
ggsave("figures/Case_IIb_fitting_plot.png", fitting_plot, width = 12, height = 8, dpi = 300)
